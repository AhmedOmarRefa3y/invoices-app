...
const CustomerCommandComp: React.FC<CustomerCommandProps> = ({ customers, slug }) => {
        ...
        <PopoverContent className="w-fit p-0  z-50">
          <Command>
            <CommandList>
              ...
              <CommandEmpty>No customer with this name</CommandEmpty>
              <CommandGroup>
                {customers.map((customerInfo) => (
                  ...
                  >
                    ...
                    <Check
                      className={cn(
                        "mr-auto h-4 w-4 ",
                        customerInfo?.id === slug ? "opacity-100" : "opacity-0"
                      )}
                    ></Check>
                  </CommandItem>
                ))}
