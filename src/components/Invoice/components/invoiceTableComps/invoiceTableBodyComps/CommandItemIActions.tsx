...
const CommandItemIActions = ({
  ...
  return (
    <>
      <td
        align="center"
        className="text-lg font-semibold border border-stone-300 border-s-0 border-t-0"
      >
        <input
      ...
      <td
        align="center"
        className="text-lg font-semibold min-w-[100px] border border-stone-300 border-s-0 border-t-0"
      >
      ...
      <td
        colSpan={1}
        align="center"
        className="text-lg border border-stone-300 border-s-0 border-t-0"
      >
        <Delete
          onClick={() => {
