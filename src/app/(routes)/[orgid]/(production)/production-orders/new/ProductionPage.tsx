...
const ProductionPage: React.FC<ProductionPageT> = ({
    ...
    return (
        <div className=" flex  w-full h-full gap-4 p-4   rounded-md  mx-auto">
            ...
            <div className="basis-[40%]">
                <div className="flex flex-col  ">
                    <div className="flex gap-2 items-center  mb-3">
                        ...
                        >
                            <SelectTrigger className="w-[50px] py-0 text-center justify-center flex items-center  rounded-none border border-neutral-950 font-bold text-lg  focus:ring-offset-0 select-none">
                                <SelectValue
                            ...
                            <SelectContent className=" text-black w-[50px] rounded-none ">
