...
const CustomerStatement: React.FC<CustomerStatementProps> = async ({ searchParams, params }) => {
  const { CustomerItemsAndPayments, customers } = await GetCustomerRecordsWithITems({
    ...searchParams,
    orgid: params.orgid,
  });
  return (
