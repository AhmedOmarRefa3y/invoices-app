      ...
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <div className="flex flex-col flex-1">
            ...
            >
              {productD.id
                ? products?.find((product) => product.id === productD.id)?.name
                : "Add Item"}
        ...
        <PopoverContent className="xl:w-[400px] w-[300px] p-0">
          <Command>
            ...
            <CommandEmpty>No item found with this name</CommandEmpty>
            <CommandGroup className=" overflow-auto max-h-[400px]">
              {products.length === 0 && (
                <CommandItem className="font-semibold text-base border-b border-stone-300 rounded-none flex  justify-center  ">
                  <span className="text-red-500">No production plan selected</span>
                </CommandItem>
              )}
                ...
                return (
                  <CommandItem
                    ...
                    onSelect={() => {
                      setproduct({
                        ...productD,
                        avaliableQuantity: product.avaliableQuantity || 0,
                        id: product.id,
                        name: product.name,
                        unit: product.unit,
                        parts: product.parts || [],
                        isAComposistion: product.isAComposistion || false,
                        quantiy: 0,
